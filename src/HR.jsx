...
return(
    ...
    <div class="container">
        ...
        <div class="row pt-5 pb-5 row-cols-lg-5 row-cols-md-2 row-cols-sm-2 row-cols-1 justify-content-around">
        <div class="card mincard col p-5">
            <div class="row justify-content-center text-white-50 pb-3"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
                ...
                <Modal show={show} onHide={handleShow} size='sm'>
                    ...
                    <Modal.Body>
                            <label>Basic Salary:<span></span></label><br></br>
                            <label>Travel Allowance:<span></span></label><br></br>
                            <label>Food Allowance:<span></span></label><br></br>
                            <label>PF:<span></span></label><br></br>
                            <label>ESI:<span></span></label><br></br><hr></hr>
                            <label>Overall Salary:<span></span></label>
                    </Modal.Body>
                    <Modal.Footer>
            ...
            <div class="card mincard col p-5">
            <div class="row justify-content-center pb-3 text-white-50"> <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-calendar-week" viewBox="0 0 16 16">
               ...
               <button className='border-0 bg-none bar p-1 fs-5 text-white' onClick={handleShow1}>
                ...
                <Modal onHide={handleShow1} show={show1} size='sm'>
                    ...
                    <Modal.Body>
                            <label>No.of Working days:<span></span></label><br></br>
                            <label>No.of Holidays:<span></span></label><br></br>
                            <label>No.of Present:<span></span></label><br></br>
                            <label>No.of CL/SL:<span></span></label><br></br>
                            <label>No.of LOP's:<span></span></label><br></br>
                    </Modal.Body>
                    <Modal.Footer>
            ...
            <div class="card mincard col p-5">
            <div class="row pb-3 text-white-50"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-clipboard2" viewBox="0 0 16 16">
            ...
            <div class="row justify-content-center text-white-50 pb-3"><svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-wallet2" viewBox="0 0 16 16">
                ...
                <button className='border-0 bg-none bar p-1 fs-5 text-white' onClick={handleShow4}>
                    ---
                </button>
                <Modal show={show4} onHide={handleShow4} size='sm'>
                    <Modal.Header>
                    <Modal.Title className='fw-bold'>Salary Slip</Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
